                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-4" style={{ display: 'inline-grid', marginBottom: '15px' }}>
                            ...
                            <button type="submit" className="site-btn" onClick={handlePhoneCall}><div className="site-text">{language === "fr" ? "Appelez Maintenant : 50 128 000" : "اتصل بنا الان : 50 128 000 "}</div></button>
                        </div>
                        <div className="col-lg-1">
                        </div>
                    </div>
